...
$bylines = array(
	'lubbers' => array(
        ...
        'playlist' => '<p>Want to listen to <a href="http://open.spotify.com/user/ericjlubbers/playlist/0qyRwyDlwECmsGb3JwPeE8" title="http://open.spotify.com/user/ericjlubbers/playlist/0qyRwyDlwECmsGb3JwPeE8">every single song we\'ve ever chosen in this Roundup</a> (we\'re over 350 tracks and inching toward <em>24 hours</em> of curated music)? <a href="http://open.spotify.com/user/ericjlubbers/playlist/0qyRwyDlwECmsGb3JwPeE8" title="http://open.spotify.com/user/ericjlubbers/playlist/0qyRwyDlwECmsGb3JwPeE8">Head over to Spotify</a>. I promise you\'ll end up with a few new favorite songs if you just pop it on shuffle and let it play. I will not be offended if you reach for the skip button, don\'t worry.</p>'),
	'schneider' => array(
